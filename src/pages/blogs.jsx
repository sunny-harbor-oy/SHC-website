    ...
    return (
        <div className="min-h-screen mt-[8vh] bg-primary w-screen font-poppins">
            ...
            <div className="grid min-h-[60vh] gap-20 md:gap-10 mt-[5vh] md:grid-cols-3 xl:grid-cols-4 md:px-[10vw]">
                <Link to={"/blogs/shc_victor"} reloadDocument="true" className="w-full h-[60vh] md:h-full relative bg-card2 md:aspect-[5/7] rounded-lg overflow-hidden hover:cursor-pointer">
                    ...
                    <div className="mt-[4%] px-[5%] w-full h-full">
                        ...
                        <p className="text-white mt-[3%] max-md:text-[120%] max-xl:text-[1.2vw] text-[1.6vh]">Tutustu SHC:n teknologiajohtajaan Victor Ocampoon. Scratchistä C-kieleen ja shakkipelistä simulaattoreista. Hän on yksi Sunny Harbour Oy:n perustajista ja IT konkari.</p>
