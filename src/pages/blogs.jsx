...
export default function BlogitPage() { 
    return (
        <div className="min-h-screen mt-[8vh] bg-primary w-screen font-poppins">
            ...
            <h2 className="text-center md:min-w-[600px] md:text-[1.3rem] md:w-[40%] mx-auto text-white text-[1]">Blogi tekstimme tarjoavat oivan mahdollisuuden tutustua teknologian maailmaan ja sen kiperiin kysymyksiin.</h2>
            <div className="grid min-h-[60vh] gap-20 md:gap-10 mt-[5vh] md:grid-cols-3 xl:grid-cols-4 md:px-[10vw]">
                <Link to={"/blogs/shc_victor"} reloadDocument="true" className="w-full h-[60vh] md:h-full relative bg-card2 md:aspect-[5/7] md:rounded-lg overflow-hidden hover:cursor-pointer">
                    ...
                    <div className="mt-[4%] px-[5%] w-full h-full">
                        ...
                        <p className="text-white mt-[3%] sm:text-[0.7rem] max-md:text-[4vw] max-xl:text-[1.2vw]">Tutustu SHC:n teknologiajohtajaan Victor Ocampoon. Scratchistä C-kieleen ja shakkipelistä simulaattoreista. Hän on yksi Sunny Harbour Oy:n perustajista ja IT konkari.</p>
