    ...
    return (
        <div className="min-h-screen mt-[8vh] bg-primary w-screen font-poppins">
            ...
            <div className="grid min-h-[60vh] gap-20 md:gap-10 mt-[5vh] max-md:grid-cols-1 md:grid-cols-3 xl:grid-cols-4 md:px-[10vw]">
                <Link to={"/blogs/shc_sisu"} reloadDocument="true" className="w-[80%] md:w-full max-md:mx-auto h-[70vh] md:h-full relative bg-card2 md:aspect-[5/7] rounded-lg overflow-hidden hover:cursor-pointer">
                    ...
                    <div className="mt-[4%] px-[5%] w-full h-full">
                        ...
                        <p className="text-white mt-[3%] max-sm:text-[0.9rem] max-md:text-[4vw] max-xl:text-[1.2vw] xl:text-[0.6rem] 2xl:text-[0.95rem]">Sisu Eriksson SHC:n toimitusjohtaja ja markkinoinnin mestari. Hän yksi Sunny Harbor Oy:n perustajista ja ollut jo nuoresta lähtien yrittäjä henkinen. Tutustu tähän kiinnostavaan tarinaan blogitekstistä.</p>
                ...
                <Link to={"/blogs/shc_victor"} reloadDocument="true" className="w-[80%] md:w-full max-md:mx-auto h-[70vh] md:h-full relative bg-card2 md:aspect-[5/7] rounded-lg overflow-hidden hover:cursor-pointer">
