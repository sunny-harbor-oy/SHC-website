...
function References() {
  return (
    <section class="bg-primary w-full mb-36">
      <div class="py-12 px-5 md:px-36">
        ...
        <div className="p-8 mb-36">
          <div className="grid justify-center w-full grid-cols-1 gap-20 md:gap-10 md:grid-cols-4">
            ...
            <div className="flex justify-center w-full">
              <img src={kvl} alt="logo" className="object-contain transition duration-1000 h-14 hover:scale-125" />
            </div>
            <div className="flex justify-center w-full ">
              <img src={moon} alt="logo" className="object-contain transition duration-1000 h-14 hover:scale-125 " />
            </div>
            <div className="flex justify-center w-full">
              <img src={kvlStore} alt="logo" className="object-contain transition duration-1000 h-14 hover:scale-125" />
            </div>
          </div>
        </div>
        <div id="referensseja">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10">
            <div className="">
              <img
                ...
                alt=""
              />
              <h2 class="mt-4 text-xl font-semibold text-white capitalize transition duration-500 hover:scale-105 hover:underline hover:cursor-pointer hover:shadow-md ">
                Korjausvelkalaskuri
              </h2>
