      ...
      >
        <div className="relative w-screen h-screen font-semibold text-white font-poppins">
          ...
          <div className="px-[5vw] pb-[2vh] h-screen flex flex-col justify-center relative z-[2]">
            ...
            Tässä vaihtoehto tän hetkiseen header tekstiin nettisivuilla: Meidän vahvuutemme on kestävien ja kustannustehokkaiden IT-ratkaisujen luomisessa, jotka eivät ainoastaan tue liiketoimintaasi, vaan myös nostavat sen uudelle tasolle. Yhteistyössämme voimme tehostaa toimintaasi ja auttaa sinua saavuttamaan ainutlaatuisen kilpailuedun markkinoilla.
            </h2>
