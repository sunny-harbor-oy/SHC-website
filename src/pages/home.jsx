...
export default function HomePage(language = "fi") {
 ...
 /*  const ilmoUpdateHeight = () => {
    ...
    ilmoContext.current.children[0].style.borderRadius = ilmoOpen
      ? `10px 10px 0px 0px`
      : `10px`;
  }; */
 ...
 /*  const ilmoVideo = (e) => {
    ...
    if (
      ...
      rect.y > -ilmoVidRef.current.getBoundingClientRect().height
    ) {
...
/*   useEffect(() => {
 ...
 {/*      <div
      ...
      <div className="bg-primary pb-[5vw]">
        <h1
          className="text-center md:text-[3vw] text-[9vw] font-semibold mx-auto md:mb-[2vw] mb-[10vw] text-secondary"
          id="customers"
        >
        ...
        >
          <div className="md:w-[90vw] w-[90vw] md:h-[40vw] h-[87vh] relative">
            ...
            <div className="relative w-full h-full md:flex">
              <h3 className="text-[3vh] font-bold py-[1vw] absolute md:hidden block text-white w-full text-center top-[13vh] font-oxanium">
                Moon App
              </h3>
              <div className="absolute md:block hidden frostedglass with-shadow w-[40vw] h-[29vw] text-white ml-[2vw] px-[2vw] py-[1vw] mt-auto mb-auto bottom-0 translate-y-[0%]">
                <h3 className="text-[1.5vw] font-semibold py-[1vw]">
                  Markkinoinnin edelläkävijä - Moon App
                </h3>
                <p className="text-[1.3vw]">
                  Moon Application on meidän uusin projekti, jonka tarkoitus on
                  mullistaa vaikuttajamarkkinointi. Sovelluksen kehityksessä
                  panostimme eniten käyttäjäkokemukseen.
                  <br />
                  <br />
                  Projektiin sisältyy web-pohjainen adminpaneeli, josta
                  hallinnoidaan sisällöntuottajien markkinointihaasteita, sekä
                  sovellus, jonka avulla vaikuttajat voivat osallistua
                  haasteisiin ja ansaita. Työstimme myös projektin kotisivut!
                  Käytimme teknologioina flutteria, typescriptiä, giniä,
                  golangia ja pythonia.{" "}
                </p>
              </div>
              <img
                src={moonPhone}
                className="absolute md:right-[7vw] md:w-[22vw] h-[83vh] object-contain md:top-[50%] max-md:right-[50%] max-md:translate-x-[50%] bottom-[-10vh] md:translate-y-[-50%]"
              />
            </div>
            <img
              src={moonLogo}
              className="object-contain absolute md:w-[4vw] w-[20vw] left-[50%] md:top-[1.5vh] top-[2vh] translate-x-[-50%]"
            ></img>
          </div>
          <div className="relative w-[90vw] md:h-[40vw] h-[87vh] bg-velka overflow-hidden">
            <img
              src={velkaImg}
              className="md:h-[11vh] max-md:h-[10vh] max-md:absolute md:relative object-contain md:py-7 left-[50%] translate-x-[-50%] max-md:top-[4vh]"
            ></img>
            <div className="md:grid grid-cols-2 hidden space-x-10 md:px-[2vw] h-[27vw]">
              <div className="my-auto md:h-full">
                <h3 className="text-[1.5vw] font-semibold py-[1vw]">
                  Isännöitsijätodistus selkokielellä
                </h3>
                <p className="text-[1.3vw] ">
                  Korjausvelkalaskuri® avaa isännöitsijäntodistuksen ja
                  korjaussuunnitelman sisällön selkeällä kielellä, tarjoten
                  yksityiskohtaisen katsauksen helposti luettavan raportin
                  muodossa taloyhtiön tuleviin remontteihin ja niiden
                  arvioituihin kustannuksiin.
                  <br />
                  <br />
                  Kehittämiseen käytetty taitomme ja teknologiat, kuten React,
                  JavaScript, Gin ja Golang, takaavat laskurin tehokkuuden ja
                  luotettavuuden. Suunnittele ja hallinnoi korjausvelkaasi
                  helposti ja pitkäjänteisesti Korjausvelkalaskurin avulla!
                </p>
              </div>
              <div className="relative px-7">
                <img
                  src={velkaLaptop}
                  className="object-contain md:block hidden absolute md:w-[35vw] mx-auto my-auto top-[50%] right-[10%] translate-y-[-50%] z-[1]"
                ></img>
                <img
                  src={velkaRaportti}
                  className="object-contain md:block hidden absolute md:w-[20vw] top-[50%] right-[2vw] translate-y-[-60%] z-[2]"
                ></img>
              </div>
            </div>
            <img
              src={velkaRaportti}
              className="object-contain md:hidden block absolute w-[80vw] bottom-[17vh] left-[50%] translate-x-[-50%]"
            ></img>
            <img
              src={velkaLaptop}
              className="object-contain md:hidden block absolute w-[80vw] bottom-[10vh] left-[50%] translate-x-[-50%]"
            ></img>
          </div>
          <div className="w-[90vw] md:h-[40vw] h-[87vh] relative bg-syke text-white overflow-hidden">
            <img
              src={sykeImg}
              className="md:h-[11vh] max-md:to-zinc-100 object-contain md:py-7 md:relative max-md:absolute max-md:h-[8vh] max-md:top-[3vh] left-[50%] translate-x-[-55%]"
            ></img>
            <div className="md:grid grid-cols-2 space-x-10 md:px-[2vw] h-[27vw] hidden">
              <div className="md:h-full my-auto translate-y-[-2.5vw]">
                <h3 className="text-[1.5vw] font-semibold py-[1vw]">
                  Tehokasta ja automatisoitua työnjakoa
                </h3>
                <p className="text-[1.3vw] ">
                  Syke Kotipalvelut tarjoaa henkilökohtaista avustajapalvelua,
                  ja OmaSyke on projekti, joka kehitettiin tukemaan heidän
                  toimintaansa ohjelmiston avulla. Kehitimme ohjelmiston, joka
                  yhdistää mobiili- ja web-alustan. Esimiehet hallinnoivat
                  työkeikkoja, käyttäjiä ja raportteja helppokäyttöisellä ja
                  monitoimisella admin-nettisivulla. <br />
                  <br />
                  Työntekijät käyttävät android- ja iOS-yhteensopivaa
                  mobiilisovellusta keikkojen lukemiseen, osallistumiseen ja
                  raportointiin. Teknologiat React, TypeScript, Gin, Golang ja
                  Flutter takaavat järjestelmän tehokkuuden ja saumattoman
                  integraation. OmaSyke tehosti ja automatisoi Syke
                  Kotihoitopalveluiden liiketoiminnan!
                </p>
              </div>
              <div className="flex justify-center px-7 md:mt-[-2vw] w-full">
                <img
                  src={sykeLaptop}
                  className="object-contain md:w-[35vw]"
                ></img>
                <img
                  src={sykePhone}
                  className="object-contain md:w-[15vw] md:mt-[-2vw] md:ml-[-13vw]"
                ></img>
              </div>
            </div>
            <img
              src={sykePhone}
              className="object-contain absolute md:hidden left-[50%] translate-x-[-50%] h-[80vh] bottom-[-7vh]"
            ></img>
          </div>
        </SlideShow>
      </div>
      ...
      <div
        ref={ilmoContext}
        style={{ transitionProperty: "all", transitionDuration: "250ms" }}
        className="transition-all duration-200 bg-ilmoSecondaryColor relative px-[1vw] py-[1vw] w-[98vw] mx-auto rounded-lg text-white font-poppins overflow-hidden"
      >
        <video
          ref={ilmoVidRef}
          src={ilmoVid}
          ...
          muted
          playsInline
          className="absolute h-[80vh] w-[98vw] object-cover rounded-lg top-0"
        ></video>
        <div className="h-[80vh] pt-[20vh] relative z-[0]">
          <h1 className="sm:text-[3vw] text-[10vw] font-poppins font-semibold text-center">
            ILMO
          </h1>
          <div className="md:block frostedglass-ilmo with-shadow w-[40vw] text-white mx-auto">
            <h3 className="text-[1.5vw] font-semibold py-[1vw] px-[2vw] w-full text-center">
              ILMO tekee työnteon sujuvaksi:<br></br>Hallitse, jaa ja seuraa
              tehtäviä helposti ja tehokkaasti organisaatiossasi!
            </h3>
          </div>
          <h2
            ref={ilmoButton}
            className="hover:cursor-pointer text-[1.8vw] font-semibold text-center px-[1vw] rounded-lg absolute top-[70vh] left-[50%] translate-x-[-50%]"
          >
            <i className="rotate-90 fa fa-angle-right"></i> Tuotteeseen{" "}
            <i className="rotate-90 fa fa-angle-right"></i>
          </h2>
        </div>
        <div className="px-[2vw] pt-[2vh] top-[80vh] w-full grid grid-cols-2">
          <div className="grid grid-cols-1 grid-rows-2 h-[50vh]">
            <div className="w-[35vw]">
              <h2 className="text-[2vw] font-poppins font-semibold">
                Mikä on ILMO?
              </h2>
              <h3 className="text-[1.2vw] font-poppins">
                ILMO on helppokäyttöinen työnjakosovellus, joka on suunniteltu
                helpottamaan organisaatioiden arkea tarjoamalla selkeän ja
                tehokkaan tavan hallita, jakaa ja seurata työtehtäviä.
              </h3>
            ...
            <div className="w-[35vw]">
              <h2 className="text-[2vw] font-poppins font-semibold">
                Sujuvoita työntekoa Ilmolla!
              </h2>
              <h3 className="text-[1.2vw] font-poppins">
                ILMO on helppokäyttöinen työnjakosovellus, joka tehostaa
                organisaatioiden työnkulkuja. Intuitiivinen käyttöliittymä
                mahdollistaa vaivattoman työtehtävien hallinnan, jakamisen ja
                seuraamisen. ILMO yhdistää tiimit ja tehtävät saumattomasti,
                tarjoten selkeän ja tehokkaan tavan parantaa työn virtausta
                organisaatiossasi.
              </h3>
            </div>
          </div>
          <div>
            ...
            <DropDown test="w-full mb-[1vh] h-[3vh]">
              <h1 className="w-full hover:cursor-pointer bg-ilmoPrimaryColor px-[1vw] py-[1vh] rounded-lg text-[1.35vw] font-poppins font-semibold">
                Miten ILMO eroaa muista työnjakosovelluksista?
              </h1>
              <h2 className="px-[1vw] py-[1vh] bg-ilmoPrimaryTextColor rounded-b-lg text-[1vw]">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex quia
                dolor assumenda obcaecati hic, culpa nisi necessitatibus harum
                ut quasi quae dignissimos odio pariatur voluptatem, fuga
                voluptas ad placeat ipsum!
              </h2>
            </DropDown>
            <DropDown test="w-full mb-[1vh]">
              <h1 className="w-full hover:cursor-pointer bg-ilmoPrimaryColor px-[1vw] py-[1vh] rounded-lg text-[1.35vw] font-poppins font-semibold">
                Onko ILMO turvallinen käyttää organisaation sisäisissä
                työtehtävissä?
              </h1>
              <h2 className="px-[1vw] py-[1vh] bg-ilmoPrimaryTextColor rounded-b-lg text-[1vw]">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex quia
            ...
            <DropDown test="w-full mb-[1vh]">
              <h1 className="w-full hover:cursor-pointer bg-ilmoPrimaryColor px-[1vw] py-[1vh] rounded-lg text-[1.35vw] font-poppins font-semibold">
                Voidaanko ILMO integroida muihin organisaation järjestelmiin?
              </h1>
              <h2 className="px-[1vw] py-[1vh] bg-ilmoPrimaryTextColor rounded-b-lg text-[1vw]">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex quia
                dolor assumenda obcaecati hic, culpa nisi necessitatibus harum
            ...
            <DropDown test="w-full mb-[1vh]">
              <h1 className="w-full hover:cursor-pointer bg-ilmoPrimaryColor px-[1vw] py-[1vh] rounded-lg text-[1.35vw] font-poppins font-semibold">
                Miksi valita ILMO työnjakosovellukseksi, ja miten se eroaa
                muista alan ratkaisuista?
              </h1>
              <h2 className="px-[1vw] py-[1vh] bg-ilmoPrimaryTextColor rounded-b-lg text-[1vw]">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex quia
                dolor assumenda obcaecati hic, culpa nisi necessitatibus harum
        ...
        <Link
          to={"/contact"}
          reloadDocument="true"
          className="text-center absolute left-[50%] translate-x-[-50%] justify-center font-poppins text-[1.5vw] pb-[1vh] font-bold"
        >
