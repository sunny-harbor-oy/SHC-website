            ...
            <div>
                <a target="_blank" className='bg-white flex flex-col lg:flex-row lg:h-[90vh] lg:justify-between grid-cols-1 md:grid-cols-2' href='https://www.linkedin.com/in/sisu-eriksson-b69475231/'>
                    <div className='w-full lg:pl-32 md:pl-10 pl-6 lg:mt-20 md:mt-10 mt-5'>
                        ...
                        <p className='text-black font-oxanium text-lg md:text-5xl lg:text-6xl md:mt-5 lg:w-full md:w-4/7 w-[64vw]'>Suunnitellaan rauhassa, toteutetaan kunnialla ja digimaailma on meidän!</p>
                ...
                <a target="_blank" className='bg-black m-0 p-0 flex justify-between flex-col lg:flex-row lg:h-[90vh] min-h-[40vh] lg:justify-between grid-cols-1 md:grid-cols-2' href='https://www.linkedin.com/in/leon-g-732b31204/'>
