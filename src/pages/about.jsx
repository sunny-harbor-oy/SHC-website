...
export default function AboutPage(language = "fi") {
  ...
  useEffect(() => {
    if (mobileScreen) {
      ...
      for (let i = 0; i < teamElems.length; i++) {
        ...
        const contentDiv =
          teamElems.length - 1 !== i
            ? teamElems[i].children[0].children[2]
            : teamElems[i].children[0].children[0].children[0].children[2];
        ...
        const sentances = description
          .split(".")
          .splice(0, window.innerWidth < 768 ? 1 : 2);
  ...
  return (
    ...
    >
      <div>
        <div className="bg-white relative md:flex justify-between md:flex-row lg:h-[45vw] md:h-[80vw] h-[85vw] lg:justify-between grid-cols-1 md:grid-cols-2">
        ...
        <div className="bg-black relative md:flex justify-between md:flex-row lg:h-[45vw] md:h-[80vw] h-[85vw] lg:justify-between grid-cols-1 md:grid-cols-2">
          <div className="w-full pl-6 pt-5 md:pl-[5vw] lg:mt-[3.5vw] md:mt-10">
            ...
            <div className="absolute left-0 md:w-[95%] w-[72vw] md:h-auto h-[60vw] lg:relative overflow-hidden">
              <p className="text-white font-poppins font-light italic text-[4.75vw] lg:text-[2vw] lg:leading-[2.56vw] md:text-[4vw] md:leading-[4.4vw] lg:mt-[0.6vw] md:mt-[2vw] lg:w-full md:w-[59vw] w-[63vw] lg:relative absolute lg:left-0 md:left-10 left-6 transition-all ease-in-out delay-250">
                "Unelmointi on tärkeä osa onnea ja menestystä, mutta sen voima
                paljastuu vasta, kun sitoudumme tavoittelemaan niitä."
              </p>
            ...
            <div className="w-full pl-6 pt-5 md:pl-[5vw] lg:mt-[3.5vw] md:mt-10">
              ...
              <div className="absolute left-0 md:w-[95%] w-[72vw] md:h-auto h-[60vw] lg:relative overflow-hidden">
                ...
                <p className="text-white font-poppins lg:font-extralight font-light lg:text-[2vw] md:text-[3vw] lg:leading-[2.25vw] md:leading-[4.4vw] text-[4.5vw] lg:mt-[2] md:mt-[1.5vw] md:relative lg:w-auto md:w-[60vw] w-[51vw] lg:left-0 left-[100vw] z-0 absolute transition-all ease-in-out delay-250">
                  ...
                  yksinkertaistamiseen. Hänen kykynsä luoda selkeitä ja
                  tehokkaita ratkaisuja tekee hänestä arvokkaan tiimipelaajan.
                  Marc on innokas tekemään monimutkaisetkin projektit
                  saumattomiksi ja helposti hallittaviksi osiksi.
                </p>
              </div>
            </div>
            <img
