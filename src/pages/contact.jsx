...
export default function ContactPage() {
    ...
    return (
        <div className='relative w-screen z-[0] bg-[#14213D] font-poppins'>
            ...
            <h1 className='text-[#FCA311] pb-1 md:text-4xl text-[7vw] font-semibold'>Ota yhteyttä!</h1>
            <h2 className='text-white md:text-[3vh] text-[4.5vw] font-light pb-4 md:w-[90vh] w-[80vw]'>Ota meihin yhteyttä käyttämällä alla olevaa lomaketta tai tee kustannusarvio laskurillamme, niin vastaamme mahdollisimman pian!</h2>
            </div>
            ...
            <div className="md:border-r-[4px] border-[#FCA311] md:min-w-[400px] h-full overflow-hidden md:px-[2vw] md:w-full">
                <h2 className="md:text-[1.8vw] text-[5.5vw] text-[#FCA311] pb-1">Nimi</h2>
                ...
                <h2 className="md:text-[1.8vw] text-[5.5vw] text-[#FCA311] pb-1">Sähköposti</h2>
                ...
                <h2 for="email" className="md:text-[1.8vw] text-[5.5vw] text-[#FCA311] pb-1">Puhelinnumero</h2>
                ...
                <p className="md:text-[1.2vw] md:w-auto w-[70%] text-[4vw] md:leading-normal leading-[4.2vw] text-white pb-1 font-light]">Kuvaile yksityiskohtaisesti tarvettasi.</p>
