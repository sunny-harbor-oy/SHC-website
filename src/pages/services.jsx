...
function ourServices() {
  return (
    <div className="w-screen overflow-x-hidden p-5 pt-28 md:p-36 bg-primary">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div>
          <h2 className="text-2xl font-bold text-white pb-1 uppercase">
            Web- ja sovelluskehitys
          </h2>
          <div className="w-[340px] bg-secondary h-1 rounded-full" />
          <br />
      ...
      <div className="col-span-2 justify-center flex flex-col w-full items-center gap-5">
        <text className="text-white text-xl text-center">
          Laske alusta tarjous kustannusarvio <a className="text-secondary cursor-pointer" href="/kustannusarviolaskuri">laskurillamme</a>
        </text>
      </div>
    </div>
  );
